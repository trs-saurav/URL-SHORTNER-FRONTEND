...
const Main = () => {
  ...
  return (
    <div className="p-8 font-sans w-full h-screen bg-gray-50 flex flex-wrap  flex-row gap-8 justify-center items-center md:items-start">
      ...
      {/* Second Div */}
      <div className="flex flex-col border-2 border-gray-300 rounded-lg shadow-md bg-white justify-center items-center w-full max-w-[30rem] h-[50rem] mb-3 p-8 overflow-y-auto flex-shrink-0">
        <input
          type="text"
